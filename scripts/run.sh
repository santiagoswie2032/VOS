...
i686-linux-g++ -ffreestanding -c kernel/kernel.cpp -o build/kernel.o
i686-linux-g++ -ffreestanding -c kernel/arch/idt.cpp -o build/idt.o
i686-linux-g++ -ffreestanding -c kernel/drivers/keyboard.cpp -o build/keyboard.o


nasm -f elf32 kernel/arch/interrupt.asm -o build/interrupt.o


i686-linux-ld -T linker.ld -o build/kernel.bin \
